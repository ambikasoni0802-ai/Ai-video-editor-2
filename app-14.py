...
with gr.Blocks(title="AI Video Editor - High Level") as demo:
    ...
    .vinu-char {
        flex-shrink: 0;
        animation: vinu-bob 2.4s ease-in-out infinite;
    }
    .vinu-arm {
        transform-origin: 70% 30%;
        animation: vinu-wave 1.2s ease-in-out infinite;
    }
    @keyframes vinu-bob {
    ...
    .vinu-bubble-text {
        animation: vinu-fade 4s ease-in-out infinite;
    }
    @keyframes vinu-fade {
    ...
    <div class="vinu-banner">
      <div class="vinu-logo">
        <div class="vinu-logo-badge">V</div>
        <div class="vinu-logo-text">Vinu</div>
      </div>

      <svg class="vinu-char" width="70" height="90" viewBox="0 0 70 90">
        <ellipse cx="35" cy="86" rx="18" ry="4" fill="rgba(0,0,0,0.15)"/>
        <circle cx="35" cy="22" r="16" fill="#F4C29A"/>
        <path d="M20 16 Q35 2 50 16 L50 12 Q35 -2 20 12 Z" fill="#3B2314"/>
        <circle cx="29" cy="22" r="2" fill="#2b2b2b"/>
        <circle cx="41" cy="22" r="2" fill="#2b2b2b"/>
        <path d="M29 29 Q35 33 41 29" stroke="#8a4b32" stroke-width="2" fill="none" stroke-linecap="round"/>
        <rect x="20" y="38" width="30" height="34" rx="10" fill="#2563EB"/>
        <g class="vinu-arm">
          <rect x="42" y="40" width="9" height="26" rx="4.5" fill="#2563EB"/>
          <circle cx="49" cy="38" r="6" fill="#F4C29A"/>
        </g>
        <rect x="19" y="42" width="9" height="24" rx="4.5" fill="#2563EB"/>
        <circle cx="23" cy="68" r="6" fill="#F4C29A"/>
        <rect x="24" y="70" width="9" height="16" rx="4" fill="#1f2937"/>
        <rect x="37" y="70" width="9" height="16" rx="4" fill="#1f2937"/>
      </svg>

      <div class="vinu-bubble-wrap">
        <div class="vinu-bubble" style="min-height:48px;">
          <span class="vinu-bubble-text" style="animation-delay:0s; position:absolute; left:18px; top:12px; right:18px;">
            Hi! Main Vinu hoon \U0001F44B Is app se video background hata sakte ho, free mein!
          </span>
          <span class="vinu-bubble-text" style="animation-delay:4s; position:absolute; left:18px; top:12px; right:18px;">
            Auto subtitles chahiye? Bas bolo "subtitles add karo"
          </span>
          <span class="vinu-bubble-text" style="animation-delay:8s; position:absolute; left:18px; top:12px; right:18px;">
            Kisi bhi bhasha mein baat karo, main samajh jaunga \U0001F30D
          </span>
          <span class="vinu-bubble-text" style="animation-delay:12s; position:absolute; left:18px; top:12px; right:18px;">
            Cinematic color, trim, speed, reverse - sab kuch ek jagah!
          </span>
        </div>
      </div>
    </div>
